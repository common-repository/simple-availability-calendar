...
class SA_Calendar_Admin_Updates {
	...
	public static function check_update( $transient ) {
		$version = SA_Calendar::get_version();
		if (empty(SA_Calendar::HOME_SITE_URL)) {
			return $transient;
		}
		$response = wp_remote_get( SA_Calendar::HOME_SITE_URL . SA_Calendar::HOME_SITE_DATA_URL . '?action=get_updates&version=' . $version );
...
SA_Calendar_Admin_Updates::init();